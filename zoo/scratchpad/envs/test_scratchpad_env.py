...
from .scratchpad_env import ScratchpadEnv, END_OF_TEXT, Action
...
class TestScratchpad:
    ...
    def test_reset(self):
        obs = self.env.reset()
        assert obs['observation']['scratchpad'][0] == END_OF_TEXT
    ...
    def test_cursor_to_input(self):
        ...
        assert obs['observation']['cursor_pos'][0] == 0
        assert obs['observation']['cursor_pos'][1] == 0
    ...
    def test_cursor_to_scratchpad(self):
        ...
        self.env.step(Action.TO_RIGHT.value)
        obs, reward, done, info = self.env.step(Action.TO_SCRATCHPAD.value)
        assert obs['observation']['cursor_pos'][0] == 1
        assert obs['observation']['cursor_pos'][1] == 0
    ...
    def test_cursor_left(self):
        ...
        assert obs1['observation']['cursor_pos'][1] == 1
        assert obs2['observation']['cursor_pos'][1] == 0
    ...
    def test_cursor_right(self):
        ...
        assert obs1['observation']['cursor_pos'][1] == 1
        assert obs2['observation']['cursor_pos'][1] == 2
    ...
    def test_highlight(self):
        ...
        assert obs1['observation']['cursor_highlight'][0] == 0
        assert obs1['observation']['cursor_highlight'][1] == 10
        assert obs1['observation']['cursor_highlight'][2] == 10
        
        assert obs2['observation']['cursor_highlight'][0] == 0
        assert obs2['observation']['cursor_highlight'][1] == 7
        assert obs2['observation']['cursor_highlight'][2] == 10
        
        assert obs3['observation']['cursor_highlight'][0] == 1
        assert obs3['observation']['cursor_highlight'][1] == 0
        assert obs3['observation']['cursor_highlight'][2] == 0
    ...
    def test_clone(self):
        ...
        for i in range(self.env.input_token_len):
            assert obs1['observation']['scratchpad'][i] == i 
    ...
    def test_delete(self):
        ...
        for i in range(1, self.env.scratchpad_token_len - 2):
            assert obs1['observation']['scratchpad'][i] == END_OF_TEXT
            
        assert obs1['observation']['scratchpad'][0] == 1
        assert obs1['observation']['scratchpad'][self.env.scratchpad_token_len - 1] == self.env.scratchpad_token_len
    ...
    def test_llm_input(self):
        ...
        for i in range(self.env.llm_input_token_len-1):
            assert obs1['observation']['llm_input'][i] == i+1
            assert obs2['observation']['llm_input'][i] == i+1
        assert obs1['observation']['llm_input'][self.env.llm_input_token_len-1] == self.env.llm_input_token_len-1+1
        assert obs2['observation']['llm_input'][self.env.llm_input_token_len-1] == END_OF_TEXT
        
        assert obs2['observation']['llm_output'][0] == END_OF_TEXT
    ...
    def test_llm_generate(self):
        ...
        assert obs1['observation']['llm_output'][0] == 0 or obs1['observation']['llm_output'][0] == 1
        assert obs1['observation']['llm_output'][1] == END_OF_TEXT
    ...
    def test_llm_delete(self):
        ...
        assert obs1['observation']['llm_output'][0] == END_OF_TEXT
    ...
    def test_llm_output(self):
        ...
        assert obs1['observation']['scratchpad'][0] == END_OF_TEXT
        assert obs1['observation']['scratchpad'][1] == obs1['observation']['llm_output'][0]
    ...
    def test_output(self):
        ...
        assert obs1['observation']['output'][0] == 1
        assert obs1['observation']['output'][1] == END_OF_TEXT
        
        assert obs2['observation']['output'][0] == 1
        assert obs2['observation']['output'][1] == 2
        assert obs2['observation']['output'][2] == END_OF_TEXT
        
        assert obs3['observation']['output'][0] == 1
        assert obs3['observation']['output'][1] == 2
        assert obs3['observation']['output'][2] == END_OF_TEXT
    ...
    def test_output_full(self):
        ...
        assert obs1['observation']['output'][self.env.output_token_len-2] == 1
        assert obs1['observation']['output'][self.env.output_token_len-1] == END_OF_TEXT
        
        assert Action.OUTPUT.value not in self.env.legal_actions 
        assert obs2['observation']['output'][self.env.output_token_len-1] == 1
        assert done2 == True
